...
class Main {
    public static void main(String[] args) {
        ...
        무기 a무기 = new 칼();
        // * 무기 a무기 = new 칼();의 처리과정
        // 1 : 메모리 구역에 칼 클래스를 사용해서 객체생성. 이때, 칼 리모콘도 생성
        // 2 : 무기 클래스로 변수 a무기를 만든다
        // 3 : 여기서 칼 리모콘이 변수 a무기에 들어가지만 a리모콘은 무기 리모콘만 들어갈 수 있으므로 리모콘이 다르다
        // 4 : 여기서 에러가 난다.
        // 5 : 하지만 칼 클래스가 무기에 상속을 받으면 칼 리모콘이 무기 리모콘으로 바뀔 수 있음
        a무기.공격();
        // 출력 : 칼로 공격합니다.
    }
}
